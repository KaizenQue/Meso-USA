...
// export default function Womenandmesothelioma() {
...
//               >
//                 Have You or a Loved One Been Affected by <span className="text-primary">Mesothelioma?</span>
//               </motion.h1>
...
//                 <Card>
//                   <CardContent>
//                     <Typography variant="h6" className="mb-2">Start Your Claim Now</Typography>
...
//             >
//               <Paper elevation={3} className="w-full max-w-2xl p-8">
...
//                       className={`rounded-[10px] bg-[#2e4a7d] text-[#f8f2e9] px-8 sm:px-12 py-3 sm:py-4 font-bold transition-colors text-sm sm:text-base md:text-lg flex items-center justify-center gap-2 ${
//                         isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-[#243c68]'
//                       }`}
//                     >
//                       {isSubmitting ? (
//                         <>
...
export default function Womenandmesothelioma() {
  ...
  return (
    <Box className="relative min-h-[100dvh] w-full overflow-hidden bg-[#F6F6F6]">
      <ToastContainer position="top-right" />
      ...
      {/* Content Container */}
      <Container maxWidth="xl" className="relative z-10 mx-auto min-h-screen">
        <Grid container spacing={4} className="min-h-screen">
          {/* Left Side - Content */}
          <Grid item xs={12} md={6}>
            <motion.div
            ...
            >
              <motion.h1
                className="mb-6 text-4xl font-bold tracking-tight md:text-5xl text-[#774A93] "
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.2, duration: 0.5 }}
              >
              ...
              >
                {[
                  ...
                  <Box key={index} className="flex items-center gap-3">
                    <Box className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary">
                      <span className="text-2xl mt-1 text-[#61336F]">•</span>
                    </Box>
                    <Typography className="text-[#61336F] font-[Poppins] text-lg font-medium leading-none">
                      <b>{text}</b>
                    </Typography>
                  </Box>
                ))}
          ...
          {/* Right Side - Form */}
          <Grid item xs={12} md={6} className="bg-[#F3EAF9]">
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
            ...
            >
              <Paper
                elevation={3}
                className="w-full max-w-2xl p-8 bg-[#F3EAF9]"
              >
                <Typography
                  variant="h5"
                  className="mb-6 text-left font- text-[#616161] text-bold "
                >
                  <b> Start Your Claim Now </b>
                </Typography>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row gap-6 md:gap-8 mt-5">
                    <div className="w-full md:flex-1">
                      <TextField
                        id="dateofDiagnosis"
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="text-xs sm:text-sm font-['Helvetica'] ">
                        <span className="block">
                          ...
                          above, even if this number is a wireless number or if
                          I am presently listed on a Do Not Call list. I
                          understand that I may be contacted by telephone,
                          email, text message or mail regarding case options and
                          that I may be called using automatic dialing
                          equipment. Message and data rates may apply. My
                          consent does not require purchase. This is Legal
                          advertising.
                        </span>
                        <span> </span>
                      </div>
