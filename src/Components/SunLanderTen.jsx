...
import Vector from "../../src/assets/millwright.png";
import {
  Button,
  TextField,
  Paper,
        ...
        >
          <Grid container spacing={4} className="min-h-screen">
              ...
              >
                ...
                <motion.p>
                  <b className="text-[#2E4A7D]">
                    If you worked as a millwright, you may have come into
                ...
                >
                  {[
                    ...
                    "Industrial sites, mechanical rooms, factories, and repair facilities across the country",
                  ].map((text, index) => (
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Justice for Millwrights Diagnosed with Mesothelioma
              </motion.h1>
