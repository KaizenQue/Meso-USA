          ...
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              ...
              >
                ...
                <motion.div
                  className="mb-8 space-y-4 mt-5"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 0.4, duration: 0.5 }}
                >
                  {[
                    "Brake pads, clutches, and transmissions",
                    "Gaskets, seals, and exhaust systems",
                    "Garages, parts stores, truck stops, and repair shops across the country",
                  ].map((text, index) => (
                    <Box
                      key={index}
                      className="flex items-start gap-3" // Changed to items-start for better text alignment
                    >
                      <Box className="flex-shrink-0 flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary text-[#6b6b6b] -mt-2">
                        <svg
                          ...
                          strokeWidth="2"
                          strokeLinecap="round"
                          className="flex-shrink-0" // Ensures SVG doesn't get squished
                        >
