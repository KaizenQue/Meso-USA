...
import Vector from "../../src/assets/funrace-klin.png";
          ...
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              ...
              >
                ...
                >
                  Justice for Furnace/Kiln Operators Diagnosed with Mesothelioma
                </motion.h1>

                <motion.p
                  className="text-[#6b6b6b] font-georgia italic font-normal leading-tight text-left mx-auto text-[21px]"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 0.2, duration: 0.5 }}
                >
                  Mesothelioma is more than just a diagnosis. It's the result of
                  years of unknowing exposure while working hard in high-heat
                  environments. If you worked around industrial equipment, you
                  may have been exposed to dangerous asbestos found in:
                </motion.p>
                <motion.div
                ...
                >
                  {[
                    "Furnace linings, kiln insulation, and firebricks",
                    "High-temperature seals, gaskets, and refractory materials",
                    "Foundries, factories, metal plants, and ceramics manufacturing facilities across the country",
                  ].map((text, index) => (
                    <Box
                      key={index}
                      className="flex items-start gap-3" // Changed to items-start for better text alignment
                    >
                      {/* Icon container with fixed size and proper alignment */}
                      <Box className="flex-shrink-0 flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary text-[#6b6b6b]">
                        <svg
                          ...
                          className="mt-0.5" // Small adjustment for perfect centering
                        >
                      ...
                      <Typography className="flex-1 pt-1.5">{text}</Typography>
                    </Box>
                  ))}
                </motion.div>
              </motion.div>
