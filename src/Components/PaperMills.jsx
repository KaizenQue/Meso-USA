...
import AutoMobileVideo from '../assets/PaperMill.mp4'
...
export default function PeperMills() {
            ...
            <Grid item xs={12} md={6} className="2xl:flex 2xl:justify-center">
              ...
              >
                ...
                >
                  ...
                  >
                    Diagnosed with Mesothelioma After Working in a Paper Mill?
                  </motion.h1>
                  ...
                  >
                    Paper mills played a vital role in American manufacturing, but many workers were unknowingly exposed to dangerous asbestos-containing materials. If you worked in a paper mill and now face a mesothelioma diagnosis, you may be entitled to compensation.
                  </motion.p>
                  ...
                  >
                    {[
                      "Dryer felts and insulation blankets",
                      "Steam pipes and turbines",
                      ...
                      <Box key={index} className="flex items-center gap-3 2xl:gap-4">
                        ...
                        <Typography className="2xl:text-lg" sx={{ fontWeight: 'bold' }}>{text}</Typography>
                      </Box>
                    ))}
                  </motion.div>
                  ...
                  >
                    <Card sx={{
                      ...
                      <CardContent>
                        ...
                        >
                          Time is limited. If you or someone you love has been diagnosed with mesothelioma after working in a paper mill, you could be eligible for substantial financial compensation.
                        </Typography>
                      </CardContent>
                    </Card>
                  </motion.div>
