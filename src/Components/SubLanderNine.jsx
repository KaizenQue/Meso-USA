...
import Vector from "../../src/assets/stell-mill-worker.png";
import {
  Button,
  TextField,
  Paper,
        ...
        >
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              <Box className="flex flex-col items-center">
                <img
                  src={Vector}
                  alt="Background"
                  className="h-[500px] w-[500px] sm:h-[250px] sm:w-[250px] md:h-[500px] md:w-[400px] rounded-full"
                />
              </Box>
              <motion.div
              ...
              >
                ...
                >
                  ...
                  years of unknowing exposure while working hard in steel
                  plants, mills, and factories.
                </motion.p>
                <motion.p>
                  <b className="text-[#2E4A7D]">
                    If you worked in the steel industry, you may have come into
                    contact with dangerous asbestos found in:
                  </b>
                </motion.p>
                <motion.div
                ...
                >
                  {[
                    "Insulation materials, fireproofing blankets, and refractory bricks",
                    "Pipe coatings, boiler rooms, and welding areas",
                    "Steel mills, fabrication plants, and construction sites across the country",
                  ].map((text, index) => (
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Justice for Steel Workers Diagnosed with Mesothelioma
              </motion.h1>
              ...
              >
                <Paper
                  elevation={3}
                  className="w-full max-w-2xl lg:-mt-16 2xl:-mt-32"
                  sx={{
