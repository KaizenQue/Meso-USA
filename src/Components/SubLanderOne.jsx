...
import Vector from "../../src/assets/auto-mechanic.png";
import {
  Button,
  TextField,
  Paper,
            ...
            <Grid item xs={12} md={6} mt={5}>
              <Box className="flex flex-col items-center">
                <img
                  src={Vector}
                  alt="Background"
                  className="h-[500px] w-[500px] sm:h-[250px] sm:w-[250px] md:h-[300px] md:w-[300px] rounded-full"
                />
              </Box>
              <motion.div
              ...
              >
                ...
                >
                  Justice for Auto Mechanics Diagnosed with Mesothelioma
                </motion.h1>
                ...
                >
                  ...
                  job. If you worked with auto parts, you may have come into
