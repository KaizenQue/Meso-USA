...
import Vector from "../../src/assets/boiler-maker.png";
          ...
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              ...
              >
                ...
                <motion.p>
                  <b className="text-[#2E4A7D] italic">
                    If you worked as a boilermaker, you may have come into
                ...
                >
                  {[
                    "Insulation, pipes, and boiler linings",
                    "Gaskets, seals, and high-temperature components",
                    "Power plants, refineries, shipyards, and industrial sites across the country",
                  ].map((text, index) => (
                    <Box key={index} className="flex items-center gap-3">
                      ...
                      <Typography className="text-[#161616] font-georgia italic leading-tight font-bold">
                        {text}
                      </Typography>
                    </Box>
                  ))}
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Justice for Boilermakers Diagnosed with Mesothelioma
              </motion.h1>
