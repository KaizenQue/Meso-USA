...
import AutoMobileVideo from '../assets/army.mp4'
            ...
            <Grid item xs={12} md={6} className="2xl:flex 2xl:justify-center">
              ...
              >
                ...
                >
                  ...
                  >
                    Served Your Country, Diagnosed with Mesothelioma?
                  </motion.h1>
                  ...
                  >
                    {[
                      ...
                      <Box key={index} className="flex items-center gap-3 2xl:gap-4">
                        ...
                        <Typography className="2xl:text-lg">{text}</Typography>
                      </Box>
                    ))}
                  </motion.div> */}
                  <motion.div
                  ...
                  >
                    <List>
                      <ListItem>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>U.S. Navy Veterans (Highest Risk Group)</Typography> 
                        </Typography>
                      </ListItem>
                      <ListItem>
                        <ListItemIcon>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>U.S. Army Veterans</Typography>
                        </Typography>
                      </ListItem>
                      <ListItem>
                        <ListItemIcon>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>U.S. Air Force Veterans</Typography>
                        </Typography>
                      </ListItem>
                    ...
                    <Card sx={{
                      ...
                      <CardContent>
                        <Box className="flex items-center gap-2 mb-2">
                          <Typography variant="h6">Claim Now</Typography>
                          <motion.div
                            animate={{
                              x: [0, 10, 0],
                              y: [0, 0, 0]
                        ...
                        >
                          If you or a loved one worked in U.S. Military and are now facing mesothelioma, take action today.
                        </Typography>
                      </CardContent>
                    </Card>
                  </motion.div>
