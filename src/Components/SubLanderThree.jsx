        ...
        >
          <Grid container spacing={4} className="min-h-screen">
              ...
              >
                ...
                <motion.p>
                  <b className="text-[#2E4A7D] italic">
                    If you worked as a steamfitter, you may have come into
                ...
                >
                  {[
                    "Pipe insulation, valves, and boilers",
                    "Gaskets, sealants, and joint compounds",
                    "Industrial plants, construction sites, refineries, and shipyards across the country",
                  ].map((text, index) => (
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Justice for Steamfitters Diagnosed with Mesothelioma
              </motion.h1>
