    ...
    <>
      ...
      <div className="hidden md:block bg-[#FAF3EC] font-georgia m-0 p-0 2xl:mt-[-30%]">
        <div className="bg-[#FAF3EC] font-georgia m-0 p-0  ">
          <div className="w-[1440px] h-[1200px] flex-shrink-0 2xl:ml-[20%] ">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="mt-[15%] ml-[30%] text-[#4B2C5E] font-feature-dlig font-georgia text-[96px] italic font-normal leading-normal text">
            ...
            <div className="p-[30px] mt-[0.5%] ml-[42%] 2xl:ml-[25%] w-[817px] h-[700px] xl:w-[800px] 2xl:h-[730px] xl:h-[730px] text-center shadow-[0_4px_8px_rgba(0,0,0,0.1)] rounded-[20px] bg-white absolute z-10">
