...
export default function MesoAutoMobile() {
  ...
  const validateForm = () => {
    ...
    //   newErrors.settlement = 'Please check this box to proceed';
    // }
            ...
            <Grid item xs={12} md={6} className="2xl:flex 2xl:justify-center">
              ...
              >
                ...
                >
                  ...
                  >
                    Diagnosed with Mesothelioma on the Job?

                  </motion.h1>

                  <motion.p
                    className="mb-6 text-lg 2xl:text-xl text-gray-600"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  >
                    <List>
                      <ListItem>
                        <ListItemIcon>
                          <CheckCircleIcon sx={{ color: '#4b2c5e' }} />
                        </ListItemIcon>
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>Auto Repair & Maintenance</Typography> - Brake Specialists, Mechanics, Clutch Repair Technicians
                        </Typography>
                      </ListItem>
                      <ListItem>
                        <ListItemIcon>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>Manufacturing & Assembly</Typography> - Automotive Assembly Line Workers, Parts Fabricators, Industrial Machine Operators
                        </Typography>
                      </ListItem>
                      <ListItem>
                        <ListItemIcon>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>Specialized Automotive Services</Typography> - Auto Body Technicians, Paint Shop Workers, Heavy Equipment Technicians
                        </Typography>
                      </ListItem>
                  ...
                  >
                    <Card sx={{
                      ...
                      <CardContent>
                        ...
                        >
                          You don't have to fight this alone. Let's fight together for the justice you deserve.
                        </Typography>
                      </CardContent>
                    </Card>
                  </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                      <div className="w-full md:flex-1">
                        <TextField
                          ...
                          inputProps={{
                            maxLength: 14 // Allows for format: +1 XXX-XXX-XXXX
                          }}
                          sx={textFieldStyle}
                        />
                      </div>
                    ...
                    <div className="text-left sm:text-left">
                      <button
                        ...
                        className={`rounded-[10px] bg-[#4b2c5e] text-[#f8f2e9] px-8 sm:px-12 py-3 sm:py-4 2xl:py-5 2xl:px-16 font-bold transition-colors text-sm sm:text-base md:text-lg 2xl:text-xl flex items-center justify-center gap-2 ${
                          isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-[#3a2249]'
                        }`}
                      >
                        {isSubmitting ? (
                          <>
