            ...
            <Grid item xs={12} md={6} className="2xl:flex 2xl:justify-center">
              ...
              >
                ...
                >
                  ...
                  >
                    If you worked in construction and have been diagnosed with mesothelioma, you may be eligible for compensation.
                  </motion.p>
                  ...
                  >
                    <List>
                      <ListItem>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>Structural Trades</Typography> - Renovation Contractors, Bricklayers and Masons
                        </Typography>
                      </ListItem>
                      <ListItem>
                        <ListItemIcon>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>Skilled Trades</Typography> - Electricians, Plumbers, Carpenters, Roofers
                        </Typography>
                      </ListItem>
                      <ListItem>
                        <ListItemIcon>
                        ...
                        <Typography>
                          <Typography component="span" sx={{ fontWeight: 'bold' }}>Mechanical Trades</Typography> - Sheet Metal Workers, Insulation Installers, Construction Laborers
                        </Typography>
                      </ListItem>
