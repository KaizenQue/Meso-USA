        ...
        <>
            ...
            <div className="hidden md:block mt-[4%]">
                <div className="flex justify-center items-center h-[50vh] bg-[#FAF3EC]">
                    <div className="flex items-center text-center max-w-[1400px] 2xl:max-w-[1900px] p-10 relative">
                        <img src={leftSvg} alt="left" className="w-full h-full absolute z-10 ml-[-10%]" />
                        <p className="text-[#2E4A7D] text-center font-georgia italic font-bold text-[32px] leading-normal [font-feature-settings:'dlig'_on] px-10 2xl:text-[50px]">
                ...
                <div className='bg-[#FAF3EC] py-16'>
                    <div className="flex items-center max-w-[105rem] mx-auto">
                        <div className="w-1/2">
                            <img src={Frame} alt="right" className="w-[393px] h-[563px] object-cover 2xl:w-[560px] 2xl:h-[800px]" />
                        </div>
                        <div className="w-2/3 pl-12 mt-64">
                            <h1 className="text-[#4B2C5E] [font-feature-settings:'dlig'_on] font-georgia italic font-normal text-[80px] 2xl:text-[140px] leading-none">
                                <div>What is</div>
                                <div>Mesothelioma?</div>
                            </h1>
                            <p className="text-[#4B2C5E] [font-feature-settings:'dlig'_on] font-helvetica text-[24px] 2xl:text-[39px] leading-normal mt-6 max-w-[900px]">
