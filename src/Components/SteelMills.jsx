...
import AutoMobileVideo from '../assets/Steel.mp4'
...
export default function SteelMills() {
            ...
            <Grid item xs={12} md={6} className="2xl:flex 2xl:justify-center">
              ...
              >
                ...
                >
                  ...
                  >
                    {[
                      "Insulation around furnaces and pipes",
                  ...
                  <motion.p
                    ...
                    transition={{ delay: 0.3, duration: 0.5 }}
                  >
                    Our legal partners specialize in occupational asbestos exposure and have helped former steelworkers win.
                  </motion.p>
