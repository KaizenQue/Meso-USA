...
import WorkerImage from "../../assets/1.png";
      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen items-center justify-center max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-3/5 text-white pl-4 lg:pl-4 pr-6 lg:pr-12 flex flex-col items-start">
          ...
          <div className="mt-24 sm:mt-28 lg:mt-12 max-w-xl">
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">Diagnosed with Mesothelioma After Years in Construction?</h1>
            <p className="mt-4 text-sm lg:text-base">
              If you worked in construction and have now been diagnosed with Mesothelioma, you're not alone, and you may be eligible for compensation.
            </p>
          </div>
          ...
          <div className="mt-24 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Structural Trades</h3>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Mechanical Trades</h3>
                <p className="text-xs mt-1">Sheet Metal Workers, Insulation Installers, Construction Laborers</p>
              </div>
            </div>
          </div>
...
export default MesotheliomaLandingPage;
