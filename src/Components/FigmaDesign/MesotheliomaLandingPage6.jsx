      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen items-center justify-center max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-3/5 text-white pl-4 lg:pl-4 pr-6 lg:pr-12 flex flex-col items-start">
          ...
          <div className="mt-24 sm:mt-28 lg:mt-12 max-w-xl">
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">Diagnosed with Mesothelioma After Working in Shipyards?</h1>
            <p className="mt-4 text-sm lg:text-base">
            Shipbuilding was critical to U.S. defence and commerce but for many shipyard workers, the job came with invisible risks. If you've been diagnosed with mesothelioma after working in a shipyard, you may be entitled to significant compensation due to asbestos exposure. 
            </p>
          </div>
          ...
          <div className="mt-24 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Pipe insulation and boiler lagging</h3>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Gaskets, valves, and pumps </h3>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Bulkhead panels and flooring materials </h3>
              </div>
            </div>
          </div>
