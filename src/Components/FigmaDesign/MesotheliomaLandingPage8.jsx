      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen items-center justify-center max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-3/5 text-white pl-4 lg:pl-4 pr-6 lg:pr-12 flex flex-col items-start">
          ...
          <div className="mt-24 sm:mt-28 lg:mt-12 max-w-xl">
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">Diagnosed with Mesothelioma After Working in a Steel Mill?</h1>
            <p className="mt-4 text-sm lg:text-base">
              Steel mill work was essential to American industry but for many, it came with hidden dangers. If you worked in a steel mill and diagnosed with mesothelioma, you may be entitled to significant compensation.
            </p>
          </div>
          ...
          <div className="mt-24 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Insulation around furnaces and pipes</h3>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Fireproof clothing and gloves</h3>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Refractory materials and bricks</h3>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-sm lg:text-base">
            <p>Our legal partners specialize in occupational asbestos exposure and have helped former steelworkers win.</p>
          </div>
...
export default MesotheliomaLandingPage8;