...
import WorkerImage from "../../assets/4.png";
      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen items-center justify-center max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-3/5 text-white pl-4 lg:pl-4 pr-6 lg:pr-12 flex flex-col items-start">
          ...
          <div className="mt-24 sm:mt-28 lg:mt-12 max-w-xl">
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">Mesothelioma After Working in an Oil Refinery?</h1>
            <p className="mt-4 text-sm lg:text-base">
              Oil refineries powered America's growth, but many refinery workers were unknowingly exposed to toxic asbestos. If you are diagnosed with mesothelioma after working in an oil refinery, you may be eligible for significant compensation.
            </p>
          </div>
          ...
          <div className="mt-24 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Pipe Insulation</h3>
                <p className="text-xs mt-1">High-temperature pipe insulation containing asbestos</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Pumps, Valves, and Gaskets</h3>
                <p className="text-xs mt-1">Critical components containing asbestos materials</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Boilers and Heat Exchangers</h3>
                <p className="text-xs mt-1">Equipment with asbestos insulation and components</p>
              </div>
            </div>
          </div>
...
export default MesotheliomaLandingPage4;