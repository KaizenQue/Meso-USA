...
export default function MesoConstructionLander() {
  ...
  return (
    <>
      ...
      <Box className="relative min-h-[100dvh] w-full overflow-hidden  bg-[#FAF3EC] pb-10">
        ...
        {/* Content Container */}
        <Container maxWidth="xl" className="relative z-10 mx-auto h-[100%]">
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              ...
              >
                <motion.h1
                  className="text-[#2E4A7D] font-georgia italic font-normal leading-tight text-center mx-auto"
                  style={{
                ...
                >
                 Diagnosed with Mesothelioma on the Construction Job? 
                </motion.h1>
    ...
    w-full sm:w-[80%] md:w-[580px]"
                  ...
                  >
                    If you worked in construction and now face a mesothelioma
                    diagnosis you're not alone, and you may be eligible for
                    compensation.
                  </motion.p>
                  <form
