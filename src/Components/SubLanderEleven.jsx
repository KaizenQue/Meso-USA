...
import Vector from "../../src/assets/construction-worker.png";
import {
  Button,
  TextField,
  Paper,
        ...
        >
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              ...
              >
                ...
                >
                  ...
                  years of unknowing exposure while working hard on job sites
                  across the country.
                </motion.p>
                <motion.p>
                  <b className="text-[#2E4A7D]">
                    If you worked in construction, you may have come into
                ...
                >
                  {[
                    "Insulation, roofing materials, and drywall",
                    "Cement, joint compounds, and floor tiles",
                    "Demolition sites, renovation projects, and old building structures",
                  ].map((text, index) => (
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Justice for Construction Workers Diagnosed with Mesothelioma
              </motion.h1>
...
export default SubLanderEleven;
