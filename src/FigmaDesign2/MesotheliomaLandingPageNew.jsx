...
import Img from "../assets/MesoFD2.jpg";
...
const MesotheliomaLandingPageNew = () => {
                ...
                <div className="relative z-10 flex h-full flex-col p-6 sm:p-8 md:p-12 lg:p-16">
                    ...
                    <div className="space-y-4 sm:space-y-6 md:max-w-[55%] pt-24 md:pt-0 md:mt-32">
                        ...
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            If you worked in the manufacturing industry and have been diagnosed with mesothelioma, your illness could be the result of long-term asbestos exposure. This wasn't your choice — but seeking compensation is. We're here to help you understand your legal options, connect with expert attorneys, and fight for the justice you deserve.
                        </p>
                    </div>
                </div>
...
export default MesotheliomaLandingPageNew;