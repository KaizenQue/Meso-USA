...
const MesotheliomaLandingPageNew3 = () => {
        ...
        <div className="flex min-h-screen flex-col">
            ...
            <div className="relative min-h-[100vh] md:h-[70vh]">
                ...
                <div className="relative z-10 flex h-full flex-col p-6 sm:p-8 md:p-12 lg:p-16">
                    ...
                    <div className="py-2 sm:px-6 sm:py-3 text-white w-46 sm:w-58 text-center text-sm sm:text-base mb-8">
                        <a href="/">
                            <img
                                src={logo}
                    ...
                    <div className="space-y-4 sm:space-y-6 md:max-w-[55%] pt-24 md:pt-0 md:mt-32">
                        ...
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            If you worked as an auto mechanic and were diagnosed with mesothelioma, your illness may have resulted from long-term exposure to asbestos found in parts like brake pads, clutches, and gaskets. This exposure wasn't your choice but seeking compensation can be. Our team connects you with expert legal help to fight for the justice and financial relief you deserve.
                        </p>
                    </div>
                </div>

                {/* Form Panel - Overlapping */}
                <div className="relative md:absolute md:right-0 md:top-[35%] w-full md:w-2/5 z-20 mt-8 mb-8 md:mt-0">
                                ...
                                {!formSubmitted && (
                                    <>
                                        <div className="mb-6 sm:mb-8 space-y-2 sm:space-y-3 text-left">
                                            ...
                                            <p className="text-sm sm:text-base text-gray-600">Get started in 30 seconds</p>
                                        </div>
                                        ...
                                        <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
                                            ...
                                            <div className="space-y-2 sm:space-y-3">
                                                ...
                                                <div className="flex">
                                                    <select
                                                        ...
                                                        onChange={handleChange}
                                                        className="flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 sm:px-4 text-xs sm:text-sm text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
                                                    >
                                            ...
                                            <button
                                                ...
                                                className={`w-full bg-[#C49A6C] hover:bg-amber-800 text-white py-3 px-4 rounded-md transition-colors duration-200 text-sm sm:text-base ${
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        <div>
                            <h3 className="text-lg sm:text-xl font-bold text-white md:text-2xl">
                                High-Risk Exposure Components for Mechanics
                            </h3>
...
export default MesotheliomaLandingPageNew3;