...
import Img from "../assets/MesoFD21.jpg";
import ImgSvg1 from '../assets/FD2img30.svg';
import ImgSvg2 from '../assets/FD2img31.svg';
import ImgSvg3 from '../assets/FD2img32.svg';
import ImgSvg4 from '../assets/FD2img33.svg';
import ImgSvg5 from '../assets/FD2img34.svg';
import ImgSvg6 from '../assets/FD2img35.svg';
...
const MesotheliomaLandingPageNew2 = () => {
                            ...
                            {[
                                ...
                                <div key={role} className="flex-1 min-w-[200px] flex items-center space-x-3 rounded-md border-2 border-[#C49A6C] p-3 sm:p-4 bg-[#4B2C5E]/80 text-white hover:bg-[#4B2C5E] transition-colors duration-200 overflow-hidden shadow-lg">
                                    <div className="flex-shrink-0 flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-white/30">
                                        <img
                                            src={[ImgSvg1, ImgSvg2, ImgSvg3, ImgSvg4, ImgSvg5, ImgSvg6, ImgSvg1][index]}
                                            alt={`${role} icon`}
...
export default MesotheliomaLandingPageNew2;